...
static NSString * kCoreDataFileName = @"easyCamera.sqlite";
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    ListFolderViewController *root = [[ListFolderViewController alloc] initWithNibName:NSStringFromClass([ListFolderViewController class]) bundle:nil];
