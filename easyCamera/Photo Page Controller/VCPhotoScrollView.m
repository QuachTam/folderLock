...
NSString * const VCPhotoScrollViewTappedNotification = @"VCPhotoScrollViewTappedNotification";

@interface VCPhotoScrollView ()<UIScrollViewDelegate>
...
@implementation VCPhotoScrollView
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:VCPhotoScrollViewTappedNotification object:recognizer];
